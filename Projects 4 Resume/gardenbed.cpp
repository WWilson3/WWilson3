...
// Project which calculates the amount of flowers that can be planted in an area consisting of a circle with plantable soil, along with 4 semi circles of the same size surrounding it.
